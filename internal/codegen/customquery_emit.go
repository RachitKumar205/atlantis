...
func EmitCustomClient(ir *dsl.IR, cfg GenConfig) ([]GoFile, error) {
	if ir == nil {
	...
	for _, ns := range sortedKeys(groups) {
		g := groups[ns]
		f, err := emitCustomClientForNamespace(ns, g, cfg)
		if err != nil {
...
func emitCustomClientForNamespace(ns string, g *customGroup, cfg GenConfig) (GoFile, error) {
	var b strings.Builder
	b.WriteString("// Code generated by tide. DO NOT EDIT.\n\n")
	fmt.Fprintf(&b, "package %s\n\n", goNamespace(ns))
