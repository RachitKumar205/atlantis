...
type IndexDecl struct {
	...
	// For partial: the raw predicate text as written (DSL `"..."` strings),
	// captured verbatim by the lexer. Parsed and validated by Postgres at IR
	// lowering (see internal/dsl/predexpr.go).
	WhereRaw string
	WherePos Position
...
// JobQueue: `queue "ingestion"` — named queue this job belongs to.
