...
func TestCRUD_PurchaseHypertable(t *testing.T) {
	...
	seed := []string{
		...
		`INSERT INTO "atlantis"."vendor_order" ("id", "vendor_id", "payment_gateway", "customer_email", "subtotal", "total_price") VALUES ('O000000001', 'V000001', 'stripe_payments', 'alice@example.com', 19.99, 19.99)`,
	}
