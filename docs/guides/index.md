...
- [Add a new entity](add-a-new-entity.md). Declare, lint, plan, apply.
- [Adopt an existing database](adopt-an-existing-database.md). Point atlantis at production tables without moving data.
- [Local development](local-development.md). One-command iteration loop reading working-tree caller `.atl` files.
- [Use the sandbox](use-the-sandbox.md). Boot, seed, checkpoint, compare, fork.
