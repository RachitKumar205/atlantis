...
- [Concepts](concepts/). `.atl` files, custom queries, caching, the `tide` / `tidectl` split.
- [How-to guides](guides/). Adding entities, writing custom queries, deploying.
- [Reference](reference/). DSL grammar, type mapping, CLI flags, env vars.
